// The search engine optimizer helps relevant users find our site more easily.
...
export const Seo = ({ description, keywords, title, image, url, author }) => {
  const site = "lora-merkel-webbutveckling.netlify.app"

  // Gathers the relevant data from the gatsby-config.js file.
  return (
    <StaticQuery
      query={detailsQuery}
      render={data => {
